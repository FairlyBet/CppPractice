...
bool DateComparison(DATE CurrentStudent, DATE NextStudent)
{
...
bool isDateEqual(DATE CurrentStudent, DATE NextStudent)
{
...
void GroupSort(struct PERSON VUZ[Amount], int* InSameFAC, int AmountInSameFAC)
{
...
void FACSort(struct PERSON VUZ[Amount])
{
